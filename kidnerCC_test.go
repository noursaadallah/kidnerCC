...
func TestKidnerCC_CreatePairNegativeAge(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte("-5"), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_CreatePairIncorrectAge(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte("a"), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_CreatePairIncorrectBloodType(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte(AGE1), []byte("wrongbloodtype"), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_CreatePairMedUrgOutBounds(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte(AGE1), []byte(BLOODTYPE1), []byte("50"), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_CreatePairPRAOutBounds(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte(AGE1), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte("150"), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_CreatePairSameType(t *testing.T) {
	scc := new(KidnerCC)
	stub := shim.NewMockStub("kidner", scc)
	res := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte(AGE1), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE1)})
	if res.Status != shim.ERROR {
		t.Log("bad status received, expected: 500; received:" + strconv.FormatInt(int64(res.Status), 10))
		t.Log("response: " + string(res.Message))
		t.FailNow()
...
func TestKidnerCC_ListActivePairsNominal(t *testing.T) {
	...
	res = stub.MockInvoke("3", [][]byte{[]byte("createPair"), []byte(AGE1), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
	pairID = res.Payload
	...
	res = stub.MockInvoke("5", [][]byte{[]byte("createPair"), []byte(AGE1), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE1), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE2)})
...
func TestKidnerCC_FindPairedMatchNominal(t *testing.T) {
	...
	res2 := stub.MockInvoke("2", [][]byte{[]byte("createPair"), []byte(AGE2), []byte(BLOODTYPE2), []byte(MEDICALURGENCY2), []byte(HLAs2), []byte(PRA2), []byte(ELIGIBLE2), []byte(TYPE1),
		[]byte(AGE1), []byte(BLOODTYPE1), []byte(MEDICALURGENCY1), []byte(HLAs1), []byte(PRA1), []byte(ELIGIBLE1), []byte(TYPE2)})
...
func TestKidnerCC_FindMatchCycleNominal(t *testing.T) {
	...
	res1 := stub.MockInvoke("1", [][]byte{[]byte("createPair"), []byte("88"), []byte("o"), []byte("0"), []byte("A1,A2,B1,B2,DR1,DR2,DQ1,DQ2"), []byte("0"), []byte("true"), []byte("donor"),
		[]byte("20"), []byte("b"), []byte("2"), []byte("A1,A2,B1,B2,DR1,DR2,DQ1,DQ2"), []byte("0"), []byte("true"), []byte("recipient")})
	pair1ID := res1.Payload
	if res1.Status != shim.OK {
		t.Log("bad status received, expected: 200 received:" + strconv.FormatInt(int64(res1.Status), 10))
		t.Log("response: " + string(res1.Message))
	...
	res2 := stub.MockInvoke("2", [][]byte{[]byte("createPair"), []byte("10"), []byte("b"), []byte("0"), []byte("A1,A2,B1,B2,DR1,DR2,DQ1,DQ2"), []byte("10"), []byte("true"), []byte("donor"),
		[]byte("18"), []byte("ab"), []byte("0"), []byte("A0,A0,B42,B42,DR42,DR42,DQ42,DQ42"), []byte("12"), []byte("true"), []byte("recipient")})
	pair2ID := res2.Payload
	if res2.Status != shim.OK {
		t.Log("bad status received, expected: 200 received:" + strconv.FormatInt(int64(res2.Status), 10))
		t.Log("response: " + string(res2.Message))
	...
	res3 := stub.MockInvoke("3", [][]byte{[]byte("createPair"), []byte("77"), []byte("a"), []byte("0"), []byte("A11,A22,B13,B24,DR15,DR26,DQ17,DQ28"), []byte("25"), []byte("true"), []byte("donor"),
		[]byte("64"), []byte("b"), []byte("1"), []byte("A1,A2,B1,B2,DR1,DR2,DQ1,DQ2"), []byte("20"), []byte("true"), []byte("recipient")})
	...
	res4 := stub.MockInvoke("4", [][]byte{[]byte("createPair"), []byte("18"), []byte("ab"), []byte("0"), []byte("A0,A0,B42,B42,DR42,DR42,DQ42,DQ42"), []byte("12"), []byte("true"), []byte("donor"),
		[]byte("77"), []byte("a"), []byte("3"), []byte("A11,A22,B13,B24,DR15,DR26,DQ17,DQ28"), []byte("12"), []byte("true"), []byte("recipient")})
