...
func createPair(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	if len(args) != 14 {
		return shim.Error(errNumArgs + "7 for each health record")
	}
	...
	donor, err := validateHealthRecordInput(args[7:]) // donor second : indices 7 -> 13
	if err != nil {
		return shim.Error(err.Error())
	}
...
func deletePair(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var err error
	PairID := args[0]
	logger.Debug("calling method - deletePair( PairID = " + PairID + ")")
...
// ============================================================================================================================
// validateHealthRecordInput : verify args to correctly create 2 health records
// ============================================================================================================================
